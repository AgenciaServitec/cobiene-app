...
export const companies = [
  ...
  // },
  {
    ...
    benefits: [
      ...
      "",
      "CONTACTOS",
      "Whatsapp: <a href='https://api.whatsapp.com/send/?phone=51942868076' target='_blank'>942 868 076</a>",
      "",
      "ALCANCE DEL CONVENIO:",
  ...
  },
  {
    ...
    benefits: [
      ...
      "",
      "CONTACTOS:",
      "SRTA. LUPE:  <a href='tel:980029739' target='_blank'>980 029 739</a>",
      "",
      "ALCANCE DEL CONVENIO:",
      "Personal militar en actividad y retiro, personal civil en actividad o cesante. Personal de servicio militar, Tropa y reenganchado. Familiares directos (cónyuge e hijos) Identificándose con CIP o CIF Y DNI.",
    ],
  ...
  },
  {
    ...
    benefits: [
      "BENEFICIOS:",
      "a)\tDescuento del 10% de sobre precio al público(consultas), veintisiete(27) especialidades médicas.",
...

  {
    ...
    benefits: [
      "BENEFICIOS",
      "TASA DE INTERES ANUAL(TEA): Hasta 16%",
      "",
      "MODALIDAD",
  ...
  },
  {
    ...
    benefits: [
      "BENEFICIO:",
      "TASA DE INTERES EFECTIVA ANUAL(TEA): 16%.",
      "",
      "MODALIDAD: PRESTAMO POR CONSUMO BAJO LA MODALIDAD DE DESCUENTO POR PLANILLA.",
      "",
      "ALCANCE DEL CONVENIO:",
  ...
  },
  {
    ...
    benefits: [
      "BENEIFICIOS",
      "TASA DE INTERES ANUAL(TEA): Hasta 15.5%",
      "",
      "MODALIDAD",
      "PRESTAMO POR CONSUMO BAJO LA MODALIDAD DE DESCUENTO POR PLANILLA.",
      "",
  ...
  },
  {
    ...
    benefits: [
      "BENEFICIOS",
      "TASA DE INTERES ANUAL(TEA): Hasta 19.5%",
      "MODALIDAD: PRESTAMO POR CONSUMO BAJO LA MODALIDAD DE DESCUENTO POR PLANILLA.",
      "",
      "ALCANCE DEL CONVENIO",
      "Dirigido al personal militar en situación de actividad o retiro y al personal civil en actividad o cesante",
