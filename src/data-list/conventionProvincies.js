export const conventionProvincies = [
  ...
  },
  {
    province: "tarapoto",
    type: "hotel",
    title: "HOTEL BELLA TERRA LAGUNA AZUL",
    benefits: [
      "Bella Terra, es un hotel ubicado en el distrito del Sauce, a orillas de la famosa Laguna Azul, en la Región San Martín. Ofrece un ambiente acogedor, cálido y tranquilo por su ubicación, donde brinda servicios de alojamiento y servicios, enfocados a parejas, familias, amigos o grupos corporativos; también actividades, internas (piscina, spa, gimnasio, bar, restaurante, áreas de recreación) y trekking, actividades acuáticas, entre otros).",
      ...
      "BENEFICIO",
      "Otorgará a los BENEFICIARIOS, acceso al 25% de descuento en los servicios de alojamiento, que incluye impuesto, servicios, internet wifi y desayuno americano en los distintos tipos de alojamiento (habitación simple, doble, matrimonial, familiar). \n",
      "*\tOtorgará a los BENEFICIARIOS, acceso al 10% de descuento en los servicios del restaurante MALOCA, en el consumo de alimentos y bebidas sobre el costo total al momento del pago. \n",
      "*\tBrindará a los BENEFICIARIOS, acceso al 5% de descuento sobre el costo total en los servicios adicionales (actividades acuáticas).\n",
      "*\tBrindará a los BENEFICIARIOS acceso al 10% de descuento en reservas para eventos corporativos y sociales, estos estarán sujetos a disponibilidad del hotel.\n",
      "*\tBrindará a los BENEFICIARIOS de “EL EJÉRCITO”, acceso al 10% sobre el costo total en la modalidad de full day.\n",
      ...
      "INFORMES:",
      "Srta. Kiara Tang – Jefa de Reservas – <a href='tel:972056619'>972056619</a>",
      "Srta. Vivi Torres y Naty Julca – Ejecutiva de Reservas – <a href='tel:972057128'>972057128</a>",
    ],
  },
];
